...
public class TopKFrequentItems {
	...
	public TopKFrequentItems(int size) {
		...
		this.size = size;
		topKItems = new PriorityQueue<TrieNodeEntry>(size,
				(TrieNodeEntry objOne, TrieNodeEntry objTwo) -> objOne.frequency - objTwo.frequency);
	}
	...
	public List<String> getKMostFreq() {
		for (TrieNodeEntry trNodeEntry : this.trImpl.getAllWords()) {
			...
			} else if (this.topKItems.peek().frequency < trNodeEntry.frequency) {
	...
	public static void main(String[] args) {
		...
		topKFrequentItems.add("Hi");
		topKFrequentItems.add("Hi");
		topKFrequentItems.add("Hello");
		topKFrequentItems.add("TShirt");
		topKFrequentItems.add("TShirt");
		topKFrequentItems.add("TShirt");
		topKFrequentItems.add("TShirt");
		topKFrequentItems.add("TShirt");
